            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              {preBuiltQuestions.map((question, index) => (
                <Button
                  ...
                  className="w-full sm:w-fit max-w-full h-auto py-2.5 px-4 sm:py-3 sm:px-5 text-xs sm:text-sm md:text-base font-normal text-left justify-start whitespace-normal break-words rounded-lg border border-secondary/30 text-secondary hover:bg-secondary/5 hover:border-secondary/50 transition-all duration-200 [&_svg]:shrink-0"
                >
                  {question}
                </Button>
              ))}
