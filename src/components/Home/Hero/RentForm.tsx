...
const RentForm = () => {
  ...
  const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      console.log('Rent search completed');
    }, 2000);
  };
  ...
  const handleRentChecker = () => {
    // Handle rent checker
    console.log('Starting rent checker');
  };
      ...
      >
        <div className='flex flex-col gap-3'>
          <div className='flex gap-3 items-center'>
            ...
            <span className='text-white text-lg md:text-xl font-bold'>Find the rental cost of a property, instantly</span>
          </div>
          <p className='font-light text-sm text-white/90'>Get a free online estimate of a property's rental income in minutes</p>
        </div>
