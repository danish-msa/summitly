    ...
    <section className="w-full py-16 bg-background">
      <div className="container-1400 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8 flex flex-col items-center justify-center">
          ...
          <TabsContent value="homes" className="mt-8 animate-fade-in w-full bg-transparent">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {homesRecommendations.map((rec, index) => (
                <Card
                  key={index}
                  className="group bg-white border border-muted/50 flex items-center gap-3 p-3 hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden"
                >
          ...
          <TabsContent value="condos" className="mt-8 animate-fade-in bg-transparent">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
