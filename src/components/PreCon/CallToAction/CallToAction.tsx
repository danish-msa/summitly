    ...
    <div className='container-1400 mx-auto px-4 sm:px-6 lg:px-8 relative bg-cover bg-center'>
      <div className='bg-gradient-to-r from-secondary to-primary rounded-2xl p-8 relative'>
        <div className='flex flex-col sm:flex-row gap-4'>
          <div className='flex flex-col sm:flex-row items-center gap-4 sm:gap-8 w-full sm:w-[80%]'>
            <Image src='/images/key.svg' className='w-10 sm:w-16 h-auto invert' alt='pre-construction' width={50} height={50} />
