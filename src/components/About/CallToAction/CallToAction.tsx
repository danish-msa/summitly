...
const CallToAction = () => {
  return (
    <div className='py-10 bg-white relative bg-cover bg-center'>
      <div className='max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 my-10'>
          <div className='flex flex-col md:flex-row gap-8 justify-center items-center rounded-2xl bg-gradient-to-r from-brand-glacier to-brand-icy-blue'>
              <div className='flex flex-col items-start gap-3 p-10'>
                  ...
                  <h2 className='text-black font-heading text-2xl md:text-3xl'>List your Properties on Summitly, join Us Now!</h2>
                  <ButtonColorful label='Join Us!' href='/contact' variant='gradient' />
              </div>
              <div className='mt-5'>
                  <BlurImage className='mt-[-45]' src='/images/cta-banner.png' width={750} height={750} alt='Call to Action' />
              </div>
          </div>
      </div>
    </div>
