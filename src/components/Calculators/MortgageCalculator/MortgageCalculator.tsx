...
import { ChevronDown, ChevronUp, Info, Table2, BarChart3, DollarSign, MapPin, Percent, Download } from "lucide-react";
...
import { MortgageCalculatorProps, ScenarioSettings, CalculatedScenario } from "./types";
import { formatNumberWithCommas, parseNumberFromString, formatCurrency } from "./utils";
import { calculateCMHC, calculateLandTransferTax, calculatePayment, getAmortizationSchedule } from "./calculations";
import { downloadCSV, prepareAmortizationTableData } from "./exportUtils";
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (amortizationViewMode === "table") {
                        ...
                        const tableData = prepareAmortizationTableData(schedule);
                        downloadCSV(tableData, "mortgage-amortization-schedule");
                      } else {
                        // Chart export would require html2canvas or similar
                        toast.error("Chart export not available. Please switch to table view to export data.");
                      }
                    }}
