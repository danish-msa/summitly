  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-pricing border border-pricing-border rounded-lg p-4 space-y-3">

          <div className="flex items-center gap-2 pb-2 border-b border-pricing-border">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            {priceData.map((item, index) => {
              ...
              return (
                ...
                <div key={index} className="bg-card rounded-md p-2.5 text-center border border-border/50">
          ...
          {additionalPricing.length > 0 && (
            ...
            <div className="pt-2 border-t border-pricing-border">
        ...
        <div className="bg-incentive border border-incentive-border rounded-lg p-4 space-y-3">

          <div className="flex items-center gap-2 pb-2 border-b border-incentive-border">
            ...
            <span className="font-semibold text-sm text-foreground">Limited Time Incentives</span>
