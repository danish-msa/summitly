    ...
    <div className='flex flex-col md:flex-row w-[90%] bg-background justify-center items-center mx-auto rounded-lg relative md:h-[800px] lg:h-[700px]'>
        ...
        <div className='w-full lg:w-1/2 py-12 px-8 md:px-12'>
            <div className='w-full'>
                <span className='text-lg block mb-2 font-semibold text-primary'>Our Benefits</span>
                <h2 className='text-2xl md:text-4xl font-bold mb-2 text-gray-800'>Why sell with us</h2>
                ...
                <div className='mt-5 rounded-xl p-5 px-8 bg-white'>
                    <h3 className='text-black text-lg mb-2'>We will market your home</h3>
                ...
                <div className='mt-5 rounded-xl p-5 px-8 bg-white'>
                    <h3 className='text-black text-lg mb-2'>We negotiate offers</h3>
                ...
                <div className='mt-5 rounded-xl p-5 px-8 bg-white'>
                    <h3 className='text-black text-lg mb-2'>We save you 50% of listing costs</h3>
