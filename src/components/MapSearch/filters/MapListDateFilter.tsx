...
interface MapListDateFilterProps extends FilterComponentProps {
  subjectListDate?: string;
}

export const MapListDateFilter: React.FC<MapListDateFilterProps> = ({
  filters,
  handleFilterChange,
  subjectListDate
}) => {
