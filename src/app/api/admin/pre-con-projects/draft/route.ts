  ...
  try {
    ...
    if (draftId) {
      ...
      const updateData: Prisma.PreConstructionProjectUncheckedUpdateInput = {
        ...
        originalPurchasePrice: originalPurchasePrice ? (typeof originalPurchasePrice === 'number' ? originalPurchasePrice : parseFloat(String(originalPurchasePrice))) : null,
        depositPaid: depositPaid ? (typeof depositPaid === 'number' ? depositPaid : parseFloat(String(depositPaid))) : null,
        totalPayment: totalPayment ? (typeof totalPayment === 'number' ? totalPayment : parseFloat(String(totalPayment))) : null,
        ...
        exposure: exposure && String(exposure).trim() ? String(exposure).trim() : null,
